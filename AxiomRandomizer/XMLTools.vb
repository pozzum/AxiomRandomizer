...
Public Class XMLEditor
    ...
    Shared Function MakeDroneCustom(EnableDrone As Boolean)
        ...
        If System.IO.File.Exists(DroneXML) Then
            ...
            For i As Integer = 0 To lines.Count - 1
                If EnableDrone Then
                    If lines(i).Contains("<THColorSchemeData mName=""Default"">") Then
                        lines(i) = lines(i).Replace("Default", "Custom")
                        Exit For
                    ElseIf lines(i).Contains("<THColorSchemeData mName=""Custom"">") Then
                        Exit For
                    End If
                Else
                    If lines(i).Contains("<THColorSchemeData mName=""Custom"">") Then
                        lines(i) = lines(i).Replace("Custom", "Default")
                        Exit For
                    ElseIf lines(i).Contains("<THColorSchemeData mName=""Default"">") Then
                        Exit For
                    End If
                End If
            Next
