    ...
    Sub LoadBatch()
        ...
        For i As Integer = 0 To RandomMenu.BatchList.Count - 1
            DataGridBatchView.Rows.Add(
               ...
               ItemCount(RandomMenu.BatchList(i).PlacedItems, GameInformation.ItemType.LabCoat).ToString,
               ItemCount(RandomMenu.BatchList(i).PlacedItems, GameInformation.ItemType.TrenchCoat).ToString,
